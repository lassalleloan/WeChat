...
\begin{tabular}{| c | p{7.5cm} | p{7.5cm} |}
  ...
  \hline
  \ref{c4} & Attaque CSRF & Authentification par jeton et par HTTP_REFERER \\
  \hline
...
\item controllers/send_mail.php
\item controllers/update_password.php
\item controllers/update_user.php
\item write_mail.php
\end{itemize}
...
\begin{itemize}
\item controllers/delete_mail.php
\item controllers/delete_user.php
\end{itemize}
